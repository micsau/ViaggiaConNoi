...
$quantità = $destinazione['quantità'];
$quantità=$quantità-1;
$sql = "UPDATE Destinazioni SET quantità = '$quantità' WHERE id = '$id_destinazione'";
$result = $connessione->query($sql);
$sql = "INSERT INTO Acquisti(id_user_fk,id_dest_fk) VALUES ('$idutente','$id_destinazione')";
    ...
    <main role="main">
      <div class="container">
        <div class="row pt-3">
          ...
          <h5>Acquisto effettuato con successo!!</h5>
          </div>
          <a href="/profile/orders" class="btn btn-outline-primary">Visualizza Ordini</a>
          <a href="/main/main.php" class="btn btn-outline-danger">Torna alla Home</a>
          </div>
        </div>
      </div>
    </main>
